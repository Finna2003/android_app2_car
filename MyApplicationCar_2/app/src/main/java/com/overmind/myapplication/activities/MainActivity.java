...
import com.taras_overmind.myapplication.DataBaseHelper;
...
//        dataBaseHandler.addOne(new CarModel("Reno", "Sedan", "Blue", 1700, 15000));
        ...
        all_contacts_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                contactsArrayAdapter = new ArrayAdapter<>(MainActivity.this, android.R.layout.simple_list_item_1, dataBaseHelper.getAll());
                lv_contactsList.setAdapter(contactsArrayAdapter);
                editAverageEngineCapacity.setText( "Average engine capacity="+String.valueOf(dataBaseHelper.getAverageEngineCapacity()));
            }
        });

        selected_contacts_btn.setOnClickListener(view -> {

            contactsArrayAdapter = new ArrayAdapter<CarModel>(MainActivity.this, android.R.layout.simple_list_item_1 , dataBaseHelper.getSelectedCars());
            lv_contactsList.setAdapter(contactsArrayAdapter);
            editAverageEngineCapacity.setText( "Average engine capacity="+String.valueOf(dataBaseHelper.getAverageEngineCapacity()));
